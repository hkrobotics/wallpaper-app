...
import { Appearance, Button, Pressable, StyleSheet, Text, View, useColorScheme } from 'react-native';
...
function LoginButtons() {
	...
	return (
		<>
			<AuthButton label={'Sign in'} icon={<Ionicons name={'logo-google'} size={24} color={theme === 'light' ? Colors.light.text : Colors.dark.icon} />} />
			<AuthButton label={'Sign in'} icon={<Ionicons name={'logo-apple'} size={24} color={theme === 'light' ? Colors.light.text : Colors.dark.icon} />} />
		</>
	);
}
